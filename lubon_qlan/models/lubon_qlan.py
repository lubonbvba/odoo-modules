...
class lubon_qlan_ip(models.Model):
	...
	tenant_id=fields.Many2one('lubon_qlan.tenants', help="Optional tenant this ip belongs to", ondelete='cascade')
	asset_id=fields.Many2one('lubon_qlan.assets', ondelete='cascade')
	site_id=fields.Many2one('lubon_qlan.sites', ondelete='cascade')
	memberships_id=fields.Many2one('lubon_qlan.memberships', string="Membership", help="Description of vlan membership")
	interface_id=fields.Many2one('lubon_qlan.interfaces', help="Interface this ip belongs to.", ondelete='cascade')
...
#	display_name=fields.Char()
	sequence=fields.Integer()
	asset_id=fields.Many2one('lubon_qlan.assets', required=True, ondelete='cascade')
	connected_to=fields.Many2one('lubon_qlan.interfaces',ondelete='set null', domain="[('site_id','=',parent.site_id)]")
